...
# Custo-m Class of Scientist. Will be used to connect name, description, and image
class Scientist:
...
sciList = [Scientist("Chemist", "A chemist searches for new knowledge about chemicals\n and uses it to improve the way we live.", "chemist.gif"),
           ...
           Scientist("Agronomist","An agronomist specializes in soil and crops.","groot.gif"),
           ...
           Scientist("Microbiologist","A microbiologist studies microscopic plants and animals.","groot.gif"),
